...
### Message size limits & channel selection

- **XMTP message limit**: 300 KiB (~300,000 ASCII chars, ~75,000-150,000 UTF-8 chars)
- **Use XMTP for**: Short agent-to-agent messages, commands, status updates, small payloads
- **Use Email for**: Long-form content (>10KB), file attachments, human-readable formal comms, audit trails requiring traditional infrastructure
- **Rule of thumb**: If it fits comfortably in a chat message, use XMTP. If it needs formatting, attachments, or archival guarantees, use Email.
